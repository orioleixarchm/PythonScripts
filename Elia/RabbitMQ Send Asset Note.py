...
#Reading json
file_path='//belgrid.net/FSApp/Rabbitmqmanager/OPER_DATA/ACC/Acc/Asset/SendAssetNote.OutBckQ/2024/05/'
...
for item in data['content']:
    iter=pd.json_normalize(json.loads(item[3:])) #encoding='utf-8-sig'
